...
export const metadata: Metadata = {
  ...
  description:
    "Un système d'exploitation pour créateurs. Atlas CRM, Studio IA, CHATEENG, WTF Lex, des outils pensés pour produire, gérer, protéger et développer votre activité.",
  openGraph: {
    title: "Suite technologique, Where Talent Forms",
    description:
