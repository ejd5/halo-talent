    ...
    <div style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto w-full max-w-5xl px-6 md:px-12 text-center">
          ...
          <h1
            className="text-[2.6rem] md:text-[4.2rem] font-bold tracking-[-0.03em] leading-[1.05] max-w-4xl mx-auto"
            style={{ fontFamily: "var(--font-display)", color: "var(--text-primary)" }}
          >
            Un copilote de chatting conçu pour{" "}
            <span
              style={{
          ...
          <p className="text-lg mt-4 max-w-2xl mx-auto" style={{ color: "var(--text-secondary)" }}>
            Halo Sovereign Chat AI aide les créateurs et agences à préparer des réponses, prioriser les conversations,
            recommander des PPV, contrôler les risques et garder une trace de chaque action.
          </p>
      ...
      {/* ─── 4. Workflow ─── */}
      <section id="workflow" className="py-20" style={{ backgroundColor: "var(--bg-surface)" }}>
        <div className="mx-auto w-full max-w-5xl px-6 md:px-12">
          <h2
            className="text-2xl md:text-3xl font-bold text-center mb-4"
            style={{ fontFamily: "var(--font-display)", color: "var(--text-primary)" }}
        ...
        <div className="mx-auto w-full max-w-5xl px-6 md:px-12">
          ...
          <div className="text-center mt-8">
            <TrackedLink
              ...
              className="inline-flex items-center gap-2 px-5 py-2 text-xs font-semibold transition-all hover:scale-[1.02]"
              style={{ border: "1px solid var(--border-default)", color: "var(--text-primary)" }}
            >
              Voir une démo →
            </TrackedLink>
