    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div>
        <div className="p-5" style={{ background: "#1A1614", border: "1px solid rgba(255,255,255,0.04)" }}>
          ...
          {/* Période */}
          <div className="mb-4">
            <p className="text-[10px] font-sans font-semibold uppercase tracking-[0.08em] mb-2" style={{ color: "#5A544C" }}>
              Période
            </p>
      ...
      <div>
        ...
        {exports.length === 0 ? (
          <div className="p-5 text-center" style={{ background: "#1A1614", border: "1px solid rgba(255,255,255,0.04)" }}>
            <FileText size={24} strokeWidth={1.5} style={{ color: "#5A544C" }} className="mx-auto mb-2" />
            ...
            {exports.map((exp) => {
              ...
              return (
                ...
                >
                  ...
                  <button className="p-1 transition-colors hover:bg-white/5" style={{ color: "#7A736B" }}>
