...
export function RevokeModal({ coManagement, onClose, onRevoked }: RevokeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(0,0,0,0.7)" }}>
      <div className="w-full max-w-md" style={{ backgroundColor: "#1A1614", border: "1px solid rgba(245,240,235,0.08)" }}>
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b" style={{ borderColor: "rgba(245,240,235,0.06)" }}>
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium" style={{ color: "#C44536" }}>Révoquer l&apos;accès</span>
          </div>
        ...
        <div className="p-4 space-y-4">
            ...
            <ol className="space-y-1">
              {steps.map((step, i) => (
                <li key={i} className="flex gap-2 text-[10px]" style={{ color: "rgba(245,240,235,0.5)" }}>
                  <span style={{ color: "#C75B39" }}>{i + 1}.</span>
                  {step}
                </li>
              ))}
            </ol>
          ...
          <label className="flex items-start gap-2 cursor-pointer">
            <input
              ...
              className="mt-0.5 accent-[#C44536] shrink-0"
            />
            <span className="text-[10px]" style={{ color: confirmed ? "#F5F0EB" : "rgba(245,240,235,0.3)" }}>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              style={{
                backgroundColor: confirmed ? "#C44536" : "rgba(245,240,235,0.06)",
                color: confirmed ? "#F5F0EB" : "rgba(245,240,235,0.2)",
              }}
            >
