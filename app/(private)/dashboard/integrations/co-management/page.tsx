  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-12">
      ...
      <div>
        ...
        >
          La solution 100% légale et sans risque pour gérer plusieurs comptes
        </p>
      </div>
      ...
      >
        ...
        révocable à tout moment, et 100% conforme.
      </div>
          ...
          <table className="w-full text-xs" style={{ borderCollapse: "separate", borderSpacing: 0 }}>
            <thead>
              <tr>
                ...
                <th className="text-left font-medium py-2.5 px-3" style={{ color: "#C44536", borderBottom: "1px solid rgba(245,240,235,0.06)" }}>Anti-detect browser</th>
                <th className="text-left font-medium py-2.5 px-3" style={{ color: "#7A9A65", borderBottom: "1px solid rgba(245,240,235,0.06)" }}>Co-management officiel</th>
              </tr>
            </thead>
            <tbody>
              {COMPARISON.map((row) => (
                <tr key={row.criterion}>
                  <td className="py-2.5 px-3 font-medium" style={{ color: "#F5F0EB", borderBottom: "1px solid rgba(245,240,235,0.04)" }}>{row.criterion}</td>
                  <td className="py-2.5 px-3" style={{ color: "rgba(196,69,54,0.6)", borderBottom: "1px solid rgba(245,240,235,0.04)" }}>
                    <div className="flex items-center gap-1.5">
                      <X size={10} style={{ color: "#C44536" }} />
                      {row.antidetect}
                    </div>
                  </td>
                  <td className="py-2.5 px-3" style={{ color: "rgba(122,154,101,0.7)", borderBottom: "1px solid rgba(245,240,235,0.04)" }}>
                    <div className="flex items-center gap-1.5">
                      <Check size={10} style={{ color: "#7A9A65" }} />
                      {row.comanage}
                    </div>
                  </td>
                </tr>
              ...
              <div key={pf.id} className="transition-all" style={{ border: "1px solid rgba(245,240,235,0.06)" }}>
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium" style={{ color: "#F5F0EB" }}>{pf.label}</span>
                    {pf.special && (
                      <span className="text-[8px] px-1.5 py-0.5" style={{ backgroundColor: "rgba(199,91,57,0.1)", color: "#C75B39" }}>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 flex items-center justify-center" style={{ backgroundColor: "rgba(122,154,101,0.1)" }}>
                    <Users size={12} style={{ color: "#7A9A65" }} />
                  </div>
                  <div>
                    <p className="text-xs font-medium" style={{ color: "#F5F0EB" }}>{cm.manager_name || cm.manager_email}</p>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[8px] px-1.5 py-0.5 uppercase tracking-wider" style={{ backgroundColor: "rgba(122,154,101,0.1)", color: "#7A9A65" }}>
                    {cm.access_level}
                  </span>
                  <button
      ...
      >
        <p className="font-medium mb-2" style={{ color: "#C75B39" }}>
          Cette fonctionnalité couvre 90% des besoins réels en gestion multi-comptes
        </p>
        <p>
          Contrairement aux anti-detect browsers, elle est{" "}
          <strong style={{ color: "#F5F0EB" }}>gratuite</strong>,{" "}
          <strong style={{ color: "#F5F0EB" }}>instantanée</strong>,{" "}
          <strong style={{ color: "#F5F0EB" }}>sécurisée</strong>, et préserve votre{" "}
          <strong style={{ color: "#F5F0EB" }}>Zero Ban Guarantee</strong>.
        </p>
      </div>
    ...
    <div className="space-y-3">
      ...
      {steps.map((s) => (
        <div key={s.num} className="flex gap-2.5" style={{ borderLeft: "1px solid rgba(245,240,235,0.06)" }}>
          ...
          <div className="pb-3">
            <p className="text-xs font-medium" style={{ color: "#F5F0EB" }}>{s.title}</p>
      ...
      {showConfirm && (
        <div className="text-[10px] p-2" style={{ backgroundColor: "rgba(122,154,101,0.06)", color: "#7A9A65" }}>
  ...
  return (
    <div className="space-y-3">
      ...
      {steps.map((s) => (
        <div key={s.num} className="flex gap-2.5" style={{ borderLeft: "1px solid rgba(245,240,235,0.06)" }}>
          <div className="flex flex-col items-center">
            <div className="w-5 h-5 flex items-center justify-center text-[9px] font-medium shrink-0" style={{ backgroundColor: "rgba(199,91,57,0.1)", color: "#C75B39" }}>
              {s.num}
            </div>
            <div className="flex-1 w-px" style={{ backgroundColor: "rgba(245,240,235,0.06)" }} />
          </div>
...
function OnlyFansGuide() {
  return (
    <div className="space-y-4">
      <div className="p-3 text-xs leading-relaxed flex items-start gap-2" style={{ backgroundColor: "rgba(199,91,57,0.08)", border: "1px solid rgba(199,91,57,0.15)" }}>
        <Info size={14} className="shrink-0 mt-0.5" style={{ color: "#C75B39" }} />
        <div>
          <p className="font-medium mb-1" style={{ color: "#C75B39" }}>Pas de système de co-management officiel</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="p-3" style={{ backgroundColor: "rgba(245,240,235,0.03)", border: "1px solid rgba(245,240,235,0.06)" }}>
          <h4 className="text-xs font-medium mb-2" style={{ color: "#F5F0EB" }}>Bitwarden Teams</h4>
        ...
        <div className="p-3" style={{ backgroundColor: "rgba(245,240,235,0.03)", border: "1px solid rgba(245,240,235,0.06)" }}>
          <h4 className="text-xs font-medium mb-2" style={{ color: "#F5F0EB" }}>1Password Teams</h4>
          <p className="text-[10px]" style={{ color: "rgba(245,240,235,0.3)" }}>
      ...
      <div className="p-3" style={{ backgroundColor: "rgba(196,69,54,0.06)", border: "1px solid rgba(196,69,54,0.1)" }}>
        <h4 className="text-[10px] font-semibold mb-1" style={{ color: "#C44536" }}>Si partage de mot de passe (dernier recours)</h4>
