  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-base mt-1" style={{ color: "var(--text-primary)" }}>Performances et statistiques détaillées</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <div key={s.label} className="p-5 border border-[var(--color-border)] card-accent" style={{ backgroundColor: "var(--color-card)" }}>
            <div className="flex items-center gap-2 mb-2"><s.icon size={16} style={{ color: "var(--text-primary)" }} /><span className="text-sm font-semibold uppercase tracking-wider" style={{ color: "var(--text-primary)" }}>{s.label}</span></div>
      ...
      <div className="p-8 border border-[var(--color-border)] flex items-center justify-center" style={{ backgroundColor: "var(--color-card)", minHeight: 320 }}>
        <div className="text-center">
          <BarChart3 size={32} className="mx-auto mb-2" style={{ color: "var(--text-primary)" }} />
          <div className="text-base" style={{ color: "var(--text-primary)" }}>Graphiques analytiques détaillés</div>
        </div>
      </div>
    </div>
  );
