...
import {
  ...
  User, Link2, Settings, ChevronDown, Globe,
...
const navSections: NavSection[] = [
  ...
  { title: "Fans", items: [
    ...
    { label: "PPV Copilot", href: "/dashboard/sovereign-chat/ppv-copilot", icon: "Bot" },
    ...
    { label: "QA Review", href: "/dashboard/sovereign-chat/qa-review", icon: "ShieldCheck" },
  ]},
