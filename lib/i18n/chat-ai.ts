...
export const chatAIMessages: Messages = {
  ...
  "chatAI.consent.4": { fr: "Je comprends que WTF ne garantit pas l'absence de restriction, suspension ou sanction de plateforme.", en: "I understand that WTF does not guarantee the absence of platform restrictions, suspensions, or sanctions.", es: "Entiendo que WTF no garantiza la ausencia de restricciones, suspensiones o sanciones de plataforma.", "pt-BR": "Entendo que a WTF não garante a ausência de restrições, suspensões ou sanções de plataforma.", de: "Ich verstehe, dass WTF keine Garantie für die Abwesenheit von Plattform-Einschränkungen, -Sperrungen oder -Sanktionen gibt.", it: "Comprendo che WTF non garantisce l'assenza di restrizioni, sospensioni o sanzioni della piattaforma." },
  "chatAI.consent.5": { fr: "Je comprends que WTF ne garantit pas de revenus.", en: "I understand that WTF does not guarantee revenue.", es: "Entiendo que WTF no garantiza ingresos.", "pt-BR": "Entendo que a WTF não garante receita.", de: "Ich verstehe, dass WTF keine Einnahmen garantiert.", it: "Comprendo che WTF non garantisce ricavi." },
  ...
  "chatAI.disclaimer.general": { fr: "WTF fournit une assistance opérationnelle. Ne remplace pas un avis juridique. Les CGU des plateformes restent applicables. Le créateur est responsable des messages envoyés.", en: "WTF provides operational assistance. Does not replace legal advice. Platform ToS remain applicable. The creator is responsible for messages sent.", es: "WTF proporciona asistencia operativa. No reemplaza asesoría legal. Los TdS de las plataformas siguen siendo aplicables. El creador es responsable de los mensajes enviados.", "pt-BR": "A WTF fornece assistência operacional. Não substitui aconselhamento jurídico. Os ToS das plataformas permanecem aplicáveis. O criador é responsável pelas mensagens enviadas.", de: "WTF bietet operative Unterstützung. Ersetzt keine Rechtsberatung. Die AGB der Plattformen bleiben anwendbar. Der Ersteller ist für gesendete Nachrichten verantwortlich.", it: "WTF fornisce assistenza operativa. Non sostituisce la consulenza legale. I TdS delle piattaforme restano applicabili. Il creatore è responsabile dei messaggi inviati." },
  "chatAI.disclaimer.no_auto_send": { fr: "WTF ne permet pas l'envoi automatique de messages. Toute action d'envoi nécessite une validation humaine.", en: "WTF does not allow automatic message sending. Any send action requires human validation.", es: "WTF no permite el envío automático de mensajes. Cualquier acción de envío requiere validación humana.", "pt-BR": "A WTF não permite o envio automático de mensagens. Qualquer ação de envio requer validação humana.", de: "WTF erlaubt kein automatisches Senden von Nachrichten. Jede Sendeaktion erfordert eine menschliche Validierung.", it: "WTF non consente l'invio automatico di messaggi. Qualsiasi azione di invio richiede la convalida umana." },
