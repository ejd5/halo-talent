...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "atlas.tab_veille": {
    ...
    es: "Vigilancia legal",
    pt: "Vigilância legal",
    de: "Rechtsbeobachtung",
    it: "Vigilanza legale",
  },
  "atlas.sources_count": {
    fr: "{count} sources suivies",
    en: "{count} sources monitored",
    es: "{count} fuentes monitoreadas",
    pt: "{count} fontes monitoradas",
    de: "{count} Quellen überwacht",
    it: "{count} fonti monitorate",
  },
  "atlas.changes_month": {
    fr: "{count} changements ce mois",
    en: "{count} changes this month",
    es: "{count} cambios este mes",
    pt: "{count} mudanças este mês",
    de: "{count} Änderungen diesen Monat",
    it: "{count} cambiamenti questo mese",
  },
  "atlas.last_scan": {
    fr: "Dernier scan",
    en: "Last scan",
  ...
  "atlas.validate": {
    fr: "Valider & publier",
    en: "Validate & publish",
    es: "Validar y publicar",
    pt: "Validar e publicar",
    de: "Bestätigen & veröffentlichen",
    it: "Convalida e pubblica",
  },
  "atlas.validated_by": {
    fr: "Validé par",
    en: "Validated by",
  ...
  "atlas.no_events": {
    fr: "Aucun changement détecté dans les CGU des plateformes pour le moment.",
    en: "No platform ToS changes detected at the moment.",
    es: "No se detectaron cambios en las CGU de las plataformas por el momento.",
    pt: "Nenhuma mudança nos Termos das plataformas detectada no momento.",
    de: "Derzeit keine Änderungen der Plattform-AGB erkannt.",
    it: "Nessun cambiamento nei Termini delle piattaforme rilevato al momento.",
  },
  "atlas.notified": {
    fr: "Créateurs notifiés",
    en: "Creators notified",
    es: "Creadores notificados",
    pt: "Criadores notificados",
    de: "Ersteller benachrichtigt",
    it: "Creatori notificati",
  },
  "atlas.subscribe": {
    fr: "S'abonner aux alertes",
    en: "Subscribe to alerts",
    es: "Suscribirse a alertas",
    pt: "Inscrever-se para alertas",
    de: "Abonnieren Sie Benachrichtigungen",
    it: "Iscriviti agli avvisi",
  },
